classdef Plot < handle
    ...
    properties (Access = protected)
        Parent_  % the parent, a ws.ChartFigure
...
% %                'Color', model.BackgroundColor,...
            ...
            % Don't do anything else, wait for our parent to tell us to
            % update
...
%         end
        ...
        function createFixedControls_(self)
            ...
            %model = self.Model ;
            parent = self.Parent_ ;
            figureGH = parent.FigureGH ;
            self.AxesGH_ = ...
                axes('Parent', figureGH, ...
                     'Units','pixels', ...
                     'HandleVisibility','off', ...
                     'Box','on' );
