...
%                 isThisElectrodeSmart=~isThisElectrodeManual;
                ...
                setPopupMenuItemsAndSelectionBang(self.CurrentMonitorPopups(i), ...
                                                  wavesurferModel.Acquisition.ChannelNames, ...
                                                  thisElectrode.CurrentMonitorChannelName, ...
                                                  fallbackItem, ...
                                                  emptyItem, ...
                                                  alwaysShowFallbackItem);
                set(self.CurrentMonitorPopups(i),'BackgroundColor',fif(isChannelOvercommitted,warningBackgroundColor,normalBackgroundColor));
                
                % Update the current monitor scale
                set(self.CurrentMonitorScaleEdits(i), ...
                ...
                set(self.CurrentMonitorScaleUnitsTexts(i), ...
                ...
                setPopupMenuItemsAndSelectionBang(self.VoltageCommandPopups(i), ...
                                                  ...
                                                  emptyItem, ...
                                                  alwaysShowFallbackItem);
                set(self.VoltageCommandPopups(i),'BackgroundColor',fif(isChannelOvercommitted,warningBackgroundColor,normalBackgroundColor));
...
%                 end
                ...
                setPopupMenuItemsAndSelectionBang(self.VoltageMonitorPopups(i), ...
                                                  ...
                                                  emptyItem, ...
                                                  alwaysShowFallbackItem);
                set(self.VoltageMonitorPopups(i),'BackgroundColor',fif(isChannelOvercommitted,warningBackgroundColor,normalBackgroundColor));
                
                % Update the voltage monitor scale
                set(self.VoltageMonitorScaleEdits(i), ...
                    'String',sprintf('%g',thisElectrode.VoltageMonitorScaling), ...
                    'BackgroundColor',fif(~didLastElectrodeUpdateWork(i),warningBackgroundColor,normalBackgroundColor));
                ...
                isChannelOvercommitted=(nElectrodesClaimingChannel>1);
                setPopupMenuItemsAndSelectionBang(self.CurrentCommandPopups(i), ...
                                                  wavesurferModel.Stimulation.AnalogChannelNames, ...
                                                  thisElectrode.CurrentCommandChannelName, ...
                                                  fallbackItem, ...
                                                  emptyItem, ...
                                                  alwaysShowFallbackItem);
                set(self.CurrentCommandPopups(i),'BackgroundColor',fif(isChannelOvercommitted,warningBackgroundColor,normalBackgroundColor));
...
%                 end
                set(self.CurrentCommandScaleEdits(i), ...
...
%             alwaysShowFallbackItem=true;
            ...
            for i=1:nElectrodes ,
                ...
                %nElectrodesClaimingChannel=model.getNumberOfElectrodesClaimingMonitorChannel(thisElectrode.CurrentMonitorChannelName);
                %isChannelOvercommitted=(nElectrodesClaimingChannel>1);
                set(self.CurrentMonitorPopups(i),'Enable',onIff(isWavesurferIdle));
...
%                                                   emptyItem, ...
%                                                   alwaysShowFallbackItem);
                set(self.VoltageCommandPopups(i),'Enable',onIff(isWavesurferIdle));
...
%                                                   emptyItem, ...
%                                                   alwaysShowFallbackItem);
                set(self.VoltageMonitorPopups(i),'Enable',onIff(isWavesurferIdle));
                ...
                %nElectrodesClaimingChannel=model.getNumberOfElectrodesClaimingCommandChannel(thisElectrode.CurrentCommandChannelName);
                %isChannelOvercommitted=(nElectrodesClaimingChannel>1);
                set(self.CurrentCommandPopups(i),'Enable',onIff(isWavesurferIdle));
    ...
    methods (Access = protected)
        ...
        function updateControlsInExistance_(self)
                ...
                for i=1:nNewElectrodes ,
                    ...
                    self.CurrentMonitorPopups(j)= ...
                        uicontrol('Parent',self.FigureGH, ...
                                  ...
                                  'Value',1, ...
                                  'Callback',@(src,evt)(self.controlActuated('',src,evt)));
                    self.CurrentMonitorScaleEdits(j)= ...
                        uicontrol('Parent',self.FigureGH, ...
                                  'Style','edit', ...
                                  'Units','pixels', ...
                                  'FontSize',8, ...
                                  ...
                                  'BackgroundColor','w',...
                                  'Callback',@(src,evt)(self.controlActuated('',src,evt)));                              
                    self.CurrentMonitorScaleUnitsTexts(j) = ...
                        uicontrol('Parent',self.FigureGH, ...
                                  'Style','text', ...
                                  'Units','pixels', ...
                                  'FontName','Tahoma', ...
                    ...
                    self.VoltageCommandPopups(j)= ...
                        uicontrol('Parent',self.FigureGH, ...
                                  ...
                                  'Value',1, ...
                                  'Callback',@(src,evt)(self.controlActuated('',src,evt)));
                    self.VoltageCommandScaleEdits(j)= ...
                        uicontrol('Parent',self.FigureGH, ...
                                  'Style','edit', ...
                                  'Units','pixels', ...
                                  'FontSize',8, ...
                                  ...
                                  'BackgroundColor','w',...
                                  'Callback',@(src,evt)(self.controlActuated('',src,evt)));         
                    self.VoltageCommandScaleUnitsTexts(j) = ...
                        uicontrol('Parent',self.FigureGH, ...
                                  'Style','text', ...
                                  'Units','pixels', ...
                                  'FontName','Tahoma', ...
            ...
            elseif nNewElectrodes<0 ,
                ...
                deleteIfValidHGHandle(self.CurrentMonitorPopups(nElectrodes+1:end));
                deleteIfValidHGHandle(self.CurrentMonitorScaleEdits(nElectrodes+1:end));
                deleteIfValidHGHandle(self.CurrentMonitorScaleUnitsTexts(nElectrodes+1:end));
                
                deleteIfValidHGHandle(self.VoltageCommandPopups(nElectrodes+1:end));
                deleteIfValidHGHandle(self.VoltageCommandScaleEdits(nElectrodes+1:end));
                deleteIfValidHGHandle(self.VoltageCommandScaleUnitsTexts(nElectrodes+1:end));
                ...
                self.CurrentMonitorPopups(nElectrodes+1:end)=[];
                self.CurrentMonitorScaleEdits(nElectrodes+1:end)=[];
                self.CurrentMonitorScaleUnitsTexts(nElectrodes+1:end)=[];
                
                self.VoltageCommandPopups(nElectrodes+1:end)=[];
                self.VoltageCommandScaleEdits(nElectrodes+1:end)=[];
                self.VoltageCommandScaleUnitsTexts(nElectrodes+1:end)=[];
        ...
        function layout_(self)
            ...
            spaceBeforeVCCols=3*interColSpaceWidth;
            ...
            tableSideSpaceWidth=5;  % the space between the left edge of the fig and the left side of the "table".  Ditto the right.
            ...
            figureWidth=tableSideSpaceWidth + ...
            ...
            %
            rowCenterY=figureHeight-titleRowHeight/2;

            labelColLeftX=tableSideSpaceWidth;
            labelColCenterX=labelColLeftX+labelColWidth/2;
            centerTextBang(self.LabelText,[labelColCenterX rowCenterY]);
            
            typeColLeftX = labelColLeftX + labelColWidth + interColSpaceWidth;
            typeColCenterX = typeColLeftX + typeColWidth/2;
            centerTextBang(self.TypeText,[typeColCenterX rowCenterY]);
            ...
            centerTextBang(self.IndexWithinTypeText,[indexWithinTypeColCenterX rowCenterY]);
            ...
            centerTextBang(self.ModeText,[modeColCenterX rowCenterY]);
            
            
            % current monitor controls
            currentMonitorColLeftX = modeColLeftX + modeColWidth + spaceBeforeVCCols;
            currentMonitorColCenterX = currentMonitorColLeftX + monitorColWidth/2;
            centerTextBang(self.CurrentMonitorText,[currentMonitorColCenterX rowCenterY]);
                        
            currentMonitorScaleColLeftX = currentMonitorColLeftX + monitorColWidth + interColSpaceWidth;
            currentMonitorScaleColCenterX = currentMonitorScaleColLeftX + monitorScaleColWidth/2;
            centerTextBang(self.CurrentMonitorScaleText,[currentMonitorScaleColCenterX rowCenterY]);

            currentMonitorScaleUnitsColLeftX = currentMonitorScaleColLeftX + monitorScaleColWidth + preUnitsShimWidth;

            
            % voltage command controls
            voltageCommandColLeftX = currentMonitorScaleUnitsColLeftX + monitorScaleUnitsColWidth + spaceBetweenMonitorAndCommandCols;
            voltageCommandColCenterX = voltageCommandColLeftX + commandColWidth/2;
            centerTextBang(self.VoltageCommandText,[voltageCommandColCenterX rowCenterY]);
            
            voltageCommandScaleColLeftX = voltageCommandColLeftX + commandColWidth + interColSpaceWidth;
            voltageCommandScaleColCenterX = voltageCommandScaleColLeftX + commandScaleColWidth/2;
            centerTextBang(self.VoltageCommandScaleText,[voltageCommandScaleColCenterX rowCenterY]);

            voltageCommandScaleUnitsColLeftX = voltageCommandScaleColLeftX + commandScaleColWidth + preUnitsShimWidth;
            ...
            centerTextBang(self.VoltageMonitorText,[voltageMonitorColCenterX rowCenterY]);
            ...
            centerTextBang(self.VoltageMonitorScaleText,[voltageMonitorScaleColCenterX rowCenterY]);
            ...
            centerTextBang(self.CurrentCommandText,[currentCommandColCenterX rowCenterY]);
            ...
            centerTextBang(self.CurrentCommandScaleText,[currentCommandScaleColCenterX rowCenterY]);
            ...
            centerTextBang(self.IsCommandEnabledText,[isCommandEnabledColCenterX rowCenterY]);
            ...
            centerTextBang(self.TestPulseQText,[testPulseQColCenterX rowCenterY]);
            ...
            centerTextBang(self.RemoveQText,[removeQColCenterX rowCenterY]);
            ...
            for i=1:nElectrodes ,
                ...
                set(self.CurrentMonitorPopups(i),'Position',[currentMonitorColLeftX rowBottomY monitorColWidth trodeRowHeight]);
                set(self.CurrentMonitorScaleEdits(i),'Position',[currentMonitorScaleColLeftX rowBottomY-5 monitorScaleColWidth trodeRowHeight+5]);  % shims make look nice
                set(self.CurrentMonitorScaleUnitsTexts(i), ...
                    'Position',[currentMonitorScaleUnitsColLeftX rowBottomY-4 monitorScaleUnitsColWidth trodeRowHeight]);  % shims make look nice
                
                set(self.VoltageCommandPopups(i),'Position',[voltageCommandColLeftX rowBottomY commandColWidth trodeRowHeight]);                
                set(self.VoltageCommandScaleEdits(i),'Position',[voltageCommandScaleColLeftX rowBottomY-5 commandScaleColWidth trodeRowHeight+5]);  % shims make look nice
                set(self.VoltageCommandScaleUnitsTexts(i), ...
                    'Position',[voltageCommandScaleUnitsColLeftX rowBottomY-4 commandScaleUnitsColWidth trodeRowHeight]);  % shims make look nice
            ...
            rowCenterY=bottomButtonRowHeight/2;
            buttonYOffset=rowCenterY-bottomButtonHeight/2;
