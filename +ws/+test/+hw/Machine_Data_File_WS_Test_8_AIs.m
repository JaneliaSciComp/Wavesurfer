...
inputDeviceIDs = {'Dev1' 'Dev1' 'Dev1' 'Dev1' 'Dev1' 'Dev1' 'Dev1' 'Dev1'}; % Cellstring identifying NI board used for the input channels.
inputChannelIDs = 0:7; % Array of channel numbers, e.g. 0:1
inputChannelNames = {'V1' 'V2' 'V3' 'V4' 'I1' 'I2' 'I3' 'I4'}; % String cell array of channel identifiers. If left empty, default NI channel names will be used.

outputDeviceIDs = {'Dev1' 'Dev1'}; % Cellstring identifying NI board used for the output channels.
...
triggerSource(1).DeviceID = 'Dev1'; % String specifying device name on which Wavesurfer self trigger is generated.
...
triggerSource(2).DeviceID = 'Dev1'; % String specifying device name on which Wavesurfer self trigger is generated.
...
triggerDestination(1).DeviceID = 'Dev1';
...
triggerDestination(2).DeviceID = 'Dev1';
