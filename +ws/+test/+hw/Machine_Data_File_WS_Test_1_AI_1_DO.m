...
physicalInputChannelNames = {'Dev1/ai0'} ;  % Cell array of strings, each string an NI physical channel name
inputChannelNames = {'ai0'}; % String cell array of channel identifiers. If left empty, default NI channel names will be used.
