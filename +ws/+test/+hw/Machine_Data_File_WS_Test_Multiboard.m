...
inputDeviceIDs = {'Dev1' 'Dev1' 'Dev2' 'Dev2'}; % Cellstring identifying NI board used for the input channels.
inputChannelIDs = [0 1 0 1]; % Array of channel numbers, e.g. 0:1
...
outputDeviceIDs = {'Dev1' 'Dev2'}; % Cellstring identifying NI board used for the output channels.
outputAnalogChannelIDs = [0 0]; % Array of AO channel numbers, e.g. 0:1.
