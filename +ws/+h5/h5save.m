...
if isstruct(value)
    ws.h5.h5savestruct(fileID, pathName, value);
elseif isnumeric(value)
    if ws.utility.isenum(value) ,
        value = double(value);
    end
    ws.h5.h5savedouble(fileID, pathName, value);
elseif islogical(value)
    ws.h5.h5savedouble(fileID, pathName, double(value));
elseif ischar(value)
    ws.h5.h5savestr(fileID, pathName, value);
elseif iscellstr(value)
    ws.h5.h5savestr(fileID, pathName, char(value));
...
elseif iscell(value)
    ws.h5.h5savecell(fileID, pathName, value);
else
