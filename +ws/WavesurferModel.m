    ...
    methods
        function self = WavesurferModel(isITheOneTrueWavesurferModel)
            ...
            if isITheOneTrueWavesurferModel ,
                ...
                looperAutomationServer = actxserver('Matlab.Application') ;
                looperAutomationServer.Visible = 0 ;  % hide window
                looperExecuteString = ...
                    sprintf('addpath(''%s''); addpath(''%s''); looper=ws.Looper(); looper.runMainLoop(); clear; quit()' , ...
                            pathToRepoRoot , ...
                            pathToMatlabZmqLib ) ;
                Execute(looperAutomationServer, looperExecuteString) ;  % this blocks, sadly      
                ...
                refillerAutomationServer = actxserver('Matlab.Application') ;
                refillerAutomationServer.Visible = 0 ;  % hide window
                refillerExecuteString = ...
                    sprintf('addpath(''%s''); addpath(''%s'');  refiller=ws.Refiller(); refiller.runMainLoop(); clear; quit()' , ...
                            pathToRepoRoot , ...
                            pathToMatlabZmqLib ) ;
                Execute(refillerAutomationServer, refillerExecuteString) ;  % this blocks, sadly
