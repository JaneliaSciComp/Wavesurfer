function newOffset = figureOffsetToPositionOnRootRelativeToUpperLeft(figureSize,leftTopOffset)
    ...
    % Calculate a new offset that will position us relative to root upper left
