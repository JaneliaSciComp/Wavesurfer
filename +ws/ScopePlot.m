...
%         end
        ...
        function setPositionAndLayout(self, ...
            ...
            plotAreaHeight = figureHeight-xAxisLabelAreaHeight-toolbarAreaHeight-statusBarAreaHeight ;
            panelXOffset = 0 ;
            panelHeight = plotAreaHeight * normalizedPlotHeight ;
            panelYOffset = figureHeight - toolbarAreaHeight - totalNormalizedHeightOfPreviousPlots*plotAreaHeight ;
