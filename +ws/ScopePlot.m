    ...
    methods
        function self = ScopePlot(parent, plotIndex, parentFigureGH)
            ...
            self.YZoomInButtonGH_ = ...
                ws.uicontrol('Parent',parentFigureGH, ...
                             'Style','pushbutton', ...
                             'String','+', ...
            ...
            % Make context menu
            self.ContextMenuGH_ = uicontextmenu('Parent', parentFigureGH) ;
