...
%         end
    ...
    methods (Access=protected)
        function layout_(self)
            ...
            spaceBetweenLabelAndRestWidth=14;
            ...
            gainColLeftX = channelLabelColLeftX+outputLabelWidth+spaceBetweenLabelAndRestWidth;
...
%               % aoScaleAndUnitsControlsWidth
            ...
            scaleColLeftX = terminalNameColLeftX + aiTerminalNamePopupWidth + spaceBetweenLabelAndRestWidth ;
            ws.utility.alignTextInRectangleBang(self.AIScaleColTitleText, ...
                                                [scaleColLeftX titleRowBottomY gainEditWidth titleRowHeight], ...
                                                'cm');
            
            isActiveColLeftX = scaleColLeftX + gainEditWidth + gainUnitSpaceWidth + ...
                               aiUnitsNumeratorTextWidth + ...
                               interUnitsSpaceWidth + ...
                               aiUnitsEditWidth + spaceBeforeIsActiveColWidth ;
...
%         end        
        ...
        function updateControlPropertiesImplementation_(self,varargin)
            ...
            nAIsInHardware = model.getNumberOfAIChannels() ;
            aiPhysicalChannelNamesInHardware = arrayfun(@(id)(sprintf('AI%d',id)), 0:(nAIsInHardware-1), 'UniformOutput', false ) ;
            ...
            for i=1:nAIs ,
                ...
                ws.utility.setPopupMenuItemsAndSelectionBang(self.AITerminalNamePopups(i), ...
                                                             aiPhysicalChannelNamesInHardware, ...
                                                             physicalChannelNames{i});
