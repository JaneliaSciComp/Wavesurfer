classdef StimulusLibraryController < ws.Controller
    ...
    methods (Access = protected)
        function createFixedControls_(self)
            ...
            % Edit menu
            self.EditMenu=uimenu('Parent',self.FigureGH_, ...
                                 'Label','Edit');
...
%                        'Label','Delete Item');
            ...
            % Tools menu
            self.ToolsMenu=uimenu('Parent',self.FigureGH_, ...
                                  'Label','Tools');
            ...
            self.SequencesListbox = ...
                ws.uilistbox('Parent',self.FigureGH_, ...
...
%             stimulusLibrary=self.Model_;  % this is the StimulusLibrary
    ...
    methods        
        ...
        function ClearLibraryMenuItemActuated(self,source,event) %#ok<INUSD>
            ...
            if isequal(choice,'Clear') ,
                self.Model_.do('clearStimulusLibrary') ;
            end
        end        
        ...
        function StimuliListboxActuated(self, source, event) %#ok<INUSD>
            ...
            self.Model_.do('setSelectedStimulusLibraryItemByClassNameAndIndex', 'ws.Stimulus', selectionIndex) ;            
        end  % function
        
        function MapsListboxActuated(self, source, event)  %#ok<INUSD>
            selectionIndex = get(source, 'Value') ;
            self.Model_.do('setSelectedStimulusLibraryItemByClassNameAndIndex', 'ws.StimulusMap', selectionIndex) ;            
        end  % function
        
        function SequencesListboxActuated(self, source, event)  %#ok<INUSD>
            selectionIndex = get(source, 'Value') ;
            self.Model_.do('setSelectedStimulusLibraryItemByClassNameAndIndex', 'ws.StimulusSequence', selectionIndex) ;
        end  % function
        
        function AddSequenceMenuItemActuated(self, source, event)  %#ok<INUSD>
            self.Model_.do('addNewStimulusSequence') ;            
        end  % function
        
        function DuplicateSequenceMenuItemActuated(self,source,event)  %#ok<INUSD>
            self.Model_.do('duplicateSelectedStimulusLibraryItem') ;
        end  % function
        
        function AddMapToSequenceMenuItemActuated(self,source,event)  %#ok<INUSD>
            self.Model_.do('addBindingToSelectedStimulusLibraryItem') ;
        end  % function
        
        function DeleteMapsFromSequenceMenuItemActuated(self,source,event) %#ok<INUSD>
            self.Model_.do('deleteMarkedBindingsFromSequence') ;
        end  % function

        function AddMapMenuItemActuated(self,source,event) %#ok<INUSD>
            self.Model_.do('addNewStimulusMap') ;
        end  % function
        ...
        function DeleteChannelsFromMapMenuItemActuated(self, source, event)  %#ok<INUSD>
            self.Model_.do('deleteMarkedChannelsFromSelectedStimulusLibraryItem') ;
        end  % function

        function AddStimulusMenuItemActuated(self, source, event)  %#ok<INUSD>
            %model=self.Model_;            
            %model.addNewStimulus('SquarePulse');
            self.Model_.do('addNewStimulus') ;
        end  % function
        ...
        function MapDurationEditActuated(self,source,event) %#ok<INUSD>
            ...
            self.Model_.do('setSelectedStimulusLibraryItemProperty', 'Duration', newValue) ;
        end  % function

        function StimulusDelayEditActuated(self,source,event) %#ok<INUSD>
            newValueAsString = get(source,'String') ;
            self.Model_.do('setSelectedStimulusLibraryItemProperty', 'Delay', newValueAsString) ;
        end  % function
        
        function StimulusDurationEditActuated(self,source,event) %#ok<INUSD>
            newValueAsString = get(source,'String') ;
            self.Model_.do('setSelectedStimulusLibraryItemProperty', 'Duration', newValueAsString) ;
        end  % function
        
        function StimulusAmplitudeEditActuated(self,source,event) %#ok<INUSD>
            newValueAsString = get(source,'String') ;
            self.Model_.do('setSelectedStimulusLibraryItemProperty', 'Amplitude', newValueAsString) ;
        end  % function
        
        function StimulusDCOffsetEditActuated(self,source,event)  %#ok<INUSD>
            newValueAsString = get(source,'String') ;
            self.Model_.do('setSelectedStimulusLibraryItemProperty', 'DCOffset', newValueAsString) ;
        end  % function
        ...
        function StimulusFunctionPopupmenuActuated(self, source, event)  %#ok<INUSD>
            ...
            self.Model_.do('setSelectedStimulusLibraryItemProperty', 'TypeString', newTypeString) ;
        end  % function
        ...
        function SequenceTableCellEdited(self,source,event)  %#ok<INUSL>
            ...
            if (columnIndex==1) ,
                ...
                self.Model_.do('setBindingOfSelectedSequenceToNamedMap', bindingIndex, newMapName) ;
            elseif (columnIndex==4) ,
                % this is the Delete? column
                newIsMarkedForDeletion = event.EditData ;
                self.Model_.do('setSelectedStimulusLibraryItemWithinClassBindingProperty', 'ws.StimulusSequence', bindingIndex, 'IsMarkedForDeletion', newIsMarkedForDeletion) ;
            end
        end  % function
        ...
        function MapTableCellEdited(self,source,event)  %#ok<INUSL>
            ...
            if (columnIndex==1) ,
                ...
                self.Model_.do('setSelectedStimulusLibraryItemWithinClassBindingProperty', 'ws.StimulusMap', indexOfBindingWithinMap, 'ChannelName', newChannelName) ; 
            elseif (columnIndex==2) ,
                ...
                self.Model_.do('setBindingOfSelectedMapToNamedStimulus', indexOfBindingWithinMap, newStimulusName) ; 
            elseif (columnIndex==4) ,
                % this is the Multiplier column
                newMultiplierAsString = event.EditData ;
                newMultiplier = str2double(newMultiplierAsString) ;
                self.Model_.do('setSelectedStimulusLibraryItemWithinClassBindingProperty', 'ws.StimulusMap', indexOfBindingWithinMap, 'Multiplier', newMultiplier) ; 
            elseif (columnIndex==5) ,
                % this is the Delete? column
                newIsMarkedForDeletion = event.EditData ;
                %self.Model_.do('setIsMarkedForDeletionForElementOfSelectedMap', indexOfElementWithinMap, newIsMarkedForDeletion) ;
                self.Model_.do('setSelectedStimulusLibraryItemWithinClassBindingProperty', 'ws.StimulusMap', indexOfBindingWithinMap, 'IsMarkedForDeletion', newIsMarkedForDeletion) ; 
            end                        
        end  % function
