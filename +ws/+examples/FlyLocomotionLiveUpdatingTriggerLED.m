classdef FlyLocomotionLiveUpdatingTriggerLED < ws.examples.FlyLocomotionLiveUpdatingBaseClass
    ...
    methods        
        function self = FlyLocomotionLiveUpdatingTriggerLED(rootModel)
            % Call superclass constructor
            self@ws.examples.FlyLocomotionLiveUpdatingBaseClass(rootModel);
        end
