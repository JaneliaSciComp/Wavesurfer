classdef DifficultUserClass < ws.UserClass
    ...
    methods        
        function self = DifficultUserClass(rootModel)
            ...
            self.ButtonGH_ = uicontrol('Parent', self.FigureGH_ , ...
                                       'Style', 'pushbutton', ...
                                       'String', 'Push Me!', ...
                                       'Callback', @self.buttonPushed ) ;
            self.AxesGH_ = axes('Parent',self.FigureGH_);
        end
        ...
        function buttonPushed(self, src, event)
            fprintf('Button was pushed!\n');
            plot(self.AxesGH_,rand(10));
        end
    end  % methods
