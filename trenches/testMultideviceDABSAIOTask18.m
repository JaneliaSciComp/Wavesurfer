...
dev2AITask.cfgDigEdgeStartTrig('/Dev1/pfi8', 'DAQmx_Val_Rising') ;
...
dev1AOTask.writeAnalogData(ao0Signal);
...
dev2AOTask.writeAnalogData(ao1Signal);
...
areTasksDone = false ;
for i = 1:20 ,
    if dev1AITask.isTaskDoneQuiet() && dev2AITask.isTaskDoneQuiet() && dev1AOTask.isTaskDoneQuiet() && dev2AOTask.isTaskDoneQuiet() ,
        areTasksDone = true ;
        break
    else
