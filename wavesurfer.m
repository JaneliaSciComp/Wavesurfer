function varargout = wavesurfer(protocolOrMDFFileName,isCommandLineOnly,isInDebugMode)
    ...
    model = ws.WavesurferModel(true, isInDebugMode);  % arg is isITheOneTrueWavesurferModel
